...
alias Dockerlogin='nvidia-docker run --rm -i -t --name joshStackMe --hostname joshStack -v /home/jjmich/:/root/  -v /mnt/project1/LSTMProbeData/:/ProbeData/ 9782989a1147 /bin/bash'
alias DockerAttach='nvidia-docker exec -i -t joshStackMe  /bin/bash'
...
alias folderSizeSorted='du -sh * | sort -hr'
